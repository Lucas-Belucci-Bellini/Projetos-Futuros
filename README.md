...
| [`compra-notebook/ORCAMENTO-20-NOTEBOOKS-COMPRA.md`](compra-notebook/ORCAMENTO-20-NOTEBOOKS-COMPRA.md) | **Dossiê de compra — 20 orçamentos de notebook** para escolher 1 até 31/12/2026: custo final com imposto, garantia, timing de Black Friday, custo de upgrade e matriz de decisão | `base-movel/notebooks` |
...
- [`pdf/compra-20-notebooks.pdf`](pdf/compra-20-notebooks.pdf) — 19 páginas, o dossiê de compra do notebook
